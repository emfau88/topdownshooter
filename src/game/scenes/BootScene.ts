...
export class BootScene extends Phaser.Scene {
  ...
  preload(): void {
    ...
    this.load.image(ASSET_KEYS.b0Character, 'assets/atlases/characters-b0.png');
    this.load.image(ASSET_KEYS.b0Environment, 'assets/atlases/environment-b0.png');
    this.load.image(ASSET_KEYS.b0Gameplay, 'assets/atlases/gameplay-b0.png');
  }
