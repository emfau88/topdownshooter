...
function actor(id: string, x: number, y: number): ActorState {
  return {
    id, name: id, team: 'blue', weapon: 'rifle', ammo: { magazine: 20, reserve: 40 }, sprite: {} as ActorState['sprite'],
    x, y, alive: true, ai: true, hp: 100, armor: 0, angle: 0, speed: 175, velocity: { x: 0, y: 0 },
